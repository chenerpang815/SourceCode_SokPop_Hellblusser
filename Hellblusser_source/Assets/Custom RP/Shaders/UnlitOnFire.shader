Shader "Custom RP/UnlitOnFire"
{	
	Properties
	{
		_BaseMap("Texture", 2D) = "white" {}
		[HDR] _BaseColor("Color", Color) = (1.0, 1.0, 1.0, 1.0)
		_FireColorA("Fire Color A", Color) = (1.0, 1.0, 1.0, 1.0)
		_FireColorB("Fire Color B", Color) = (1.0, 1.0, 1.0, 1.0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma vertex OnFirePassVertex
			#pragma fragment OnFirePassFragment
			#include "OnFirePass.hlsl"
			ENDHLSL
		}
