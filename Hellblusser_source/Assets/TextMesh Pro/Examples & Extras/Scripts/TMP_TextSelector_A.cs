        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                if (charIndex != -1 && charIndex != m_lastCharIndex && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    Color32 c = new Color32((byte)TommieRandom.instance.RandomRange(0, 255), (byte)TommieRandom.instance.RandomRange(0, 255), (byte)TommieRandom.instance.RandomRange(0, 255), 255);
