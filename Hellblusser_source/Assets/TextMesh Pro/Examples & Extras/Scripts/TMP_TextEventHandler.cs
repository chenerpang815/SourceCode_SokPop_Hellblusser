...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        void LateUpdate()
        {
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, SetupManager.instance.mousePosition, m_Camera))
            {
                #region Example of Character or Sprite Selection
                int charIndex = TMP_TextUtilities.FindIntersectingCharacter(m_TextComponent, SetupManager.instance.mousePosition, m_Camera, true);
                ...
                int wordIndex = TMP_TextUtilities.FindIntersectingWord(m_TextComponent, SetupManager.instance.mousePosition, m_Camera);
                ...
                // Check if Mouse intersects any words and if so assign a random color to that word.
                int lineIndex = TMP_TextUtilities.FindIntersectingLine(m_TextComponent, SetupManager.instance.mousePosition, m_Camera);
                ...
                int linkIndex = TMP_TextUtilities.FindIntersectingLink(m_TextComponent, SetupManager.instance.mousePosition, m_Camera);
