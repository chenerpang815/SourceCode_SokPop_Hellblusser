    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                m_textMeshPro.color = new Color32((byte)TommieRandom.instance.RandomRange(0, 255), (byte)TommieRandom.instance.RandomRange(0, 255), (byte)TommieRandom.instance.RandomRange(0, 255), 255);
            ...
            else if (SpawnType == 1)
            {
                ...
                m_textMesh.color = new Color32((byte)TommieRandom.instance.RandomRange(0, 255), (byte)TommieRandom.instance.RandomRange(0, 255), (byte)TommieRandom.instance.RandomRange(0, 255), 255);
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            float starting_Count = TommieRandom.instance.RandomRange(5f, 20f); // At what number is the counter starting at.
            ...
            yield return k_WaitForSecondsRandom[(int)TommieRandom.instance.RandomRange(0, 19)];
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            yield return k_WaitForSecondsRandom[(int)TommieRandom.instance.RandomRange(0, 20)];
